      ...
      <div className="w-full max-w-md">      <div className="w-full max-w-md">
        ...
        >        >
          ...
          <div className="text-center">          {/* Brand */}
            ...
            <p className="text-sm text-gray-600">Welcome back</p>                BiteCheck

          </div>              </h1>

            </Link>

          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">            <p className="text-sm text-gray-600">Welcome back</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">          </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"              {/* Google Sign In Button */}
              ...
              <div>                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-shadow"
                ...
                <div className="relative">                />
                  ...
                  <input              </div>
                    ...
                    autoComplete="current-password"                <div className="relative">
                  ...
                  >                    placeholder="••••••••"
                    ...
                    {showPassword ? <FaEyeSlash /> : <FaEye />}                    autoComplete="current-password"
              ...
              {errorMessage && (                    onClick={() => setShowPassword(!showPassword)}

                <div className="text-sm text-red-600 bg-red-50 border border-red-200 rounded-lg px-3 py-2">                    className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600"

                  {errorMessage}                  >

                </div>                    {showPassword ? <FaEyeSlash /> : <FaEye />}
              ...
              <button              </div>
                ...
                className="w-full bg-orange-500 text-white py-2.5 rounded-lg font-medium hover:bg-orange-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"                <div className="text-sm text-red-600 bg-red-50 border border-red-200 rounded-lg px-3 py-2">
              ...
              >                  {errorMessage}
                ...
                {loading ? (                </div>
                  ...
                  'Sign in'                className="w-full bg-orange-500 text-white py-2.5 rounded-lg font-medium hover:bg-orange-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <p className="text-center text-sm text-gray-600">                    <div className="h-4 w-4 animate-spin rounded-full border-2 border-white/30 border-t-white"></div>

                Don't have an account?{' '}                    Signing in...

                <Link href="/auth/signup" className="text-orange-500 hover:text-orange-600 font-medium">                  </span>
        ...
        </motion.div>              <p className="text-center text-sm text-gray-600">

      </div>                Don't have an account?{' '}

    </div>                <Link href="/auth/signup" className="text-orange-500 hover:text-orange-600 font-medium">
