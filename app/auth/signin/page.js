      ...
      <div className="relative z-10 flex flex-col md:flex-row min-h-screen">
        ...
        <div className="flex-1 flex items-center justify-center p-10 hidden md:flex">
          ...
          >
            <h1 className="text-6xl font-extrabold tracking-tight leading-[1.05]">
              <span className="text-white drop-shadow-[0_0_6px_rgba(255,255,255,0.4)]">BiteCheck</span>
            </h1>
            <p className="mt-6 text-lg text-gray-300 font-light leading-relaxed">
              Review Like a True Critic. Share your culinary journey with the world.
            </p>
        ...
        <div className="flex-1 flex items-center justify-center p-6 sm:p-10">
          <motion.div 
            ...
            className="w-full max-w-md bg-white/10 border border-white/15 shadow-2xl rounded-2xl backdrop-blur-xl p-8 relative overflow-hidden"
          >
            ...
            <div className="relative">
              ...
              <p className="mt-2 text-sm text-gray-300">Welcome back. Let’s get you tasting.</p>
              ...
              <form onSubmit={handleSubmit} className="mt-10 space-y-7">
                ...
                <div className="text-sm text-center text-gray-400">
                  New here?{' '}
                  <a href="/auth/signup" className="text-orange-400 hover:text-orange-300 font-medium">Create an account</a>
                </div>
              </form>
            </div>
          </motion.div>
