      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-16 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="mb-10 text-center">
            ...
            <p className="mt-3 text-sm text-white/60">Welcome back. Sign in to continue.</p>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center text-sm text-white/60">
                New here?{' '}
                <Link href="/auth/signup" className="font-medium text-white transition hover:text-white/80">
                  Create an account
                </Link>
              </div>
            </form>
